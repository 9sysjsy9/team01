...
$(function() {
	...
	$("#checkOrderNum").click(function() {
		...
		$.post(url, sData, function(rData){
			console.log(rData);
			console.log(rData.order_code);
			console.log(rData.order_shoescode);
			console.log(rData.order_regdate);
			console.log(rData.order_shoesprice);
			$("#spanMsg").text(rData.order_regdate+"/"+rData.user_id+"/"+rData.order_shoescode);
		});
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="jumbotron" class="harf_area" style="padding-left: 120px;">
						...
						<tr>
							...
							<td>
								<div class="bg-select" style="padding-left: 10px;">
									<select id="qa_kind" name="qa_kind" style="font-size: 20px">
					...
					<tbody>
						<tr>
							...
							<td class="order-check" style="padding-left: 10px;"><input
								type="text" name="order_code" class="n-input" 
...
<!-- 조회 모달 필요 부분 시작 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
								...
								<button type="button" class="btn btn-sm btn-primary my-2 my-sm-0" 
									 id="checkOrderNum"> 조회</button> <span id="spanMsg"></span>
						</tr>
					</tbody>
					<tbody>
