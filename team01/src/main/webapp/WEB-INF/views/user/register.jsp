      ...
      <tr>
       ...
       <tr>
         ...
         <tr>
           <th> 관심분야 </th>
           <td>
              <input type='checkbox' name='interest[]' value='17'> 운동화
              <input type='checkbox' name='interest[]' value='18'> 구두
              <input type='checkbox' name='interest[]' value='19'> 로퍼
              <input type='checkbox' name='interest[]' value='20'> 캐쥬얼
              <input type='checkbox' name='interest[]' value='21'> 기능성
              <input type='checkbox' name='interest[]' value='22'> 수제화
            </td>
         </tr>
         <tr>
           <th>가입경로</th>
