		...
		<div class="row gx-4 gx-lg-5 align-items-center">
			...
			<div class="col-md-6">
				...
				<div class="d-flex">
					...
					<button class="firstStoreBtn btn btn-outline-primary flex-shrink-0" type="button"
						onclick="panTo1()">
						<i class="bi-cart-fill me-1"></i> 1호점
					</button>
					<button class="secondStoreBtn btn btn-outline-primary flex-shrink-0" type="button"
						onclick="panTo2()">
						<i class="bi-cart-fill me-1"></i> 2호점
					</button>
				</div>
			</div>
		</div>
