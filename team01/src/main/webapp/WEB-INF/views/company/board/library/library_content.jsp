...
$(function(){
	$(".btnMove").click(function(e) {
		...
		if(move == "0"){
			...
			location.href = "/company/board/library/library_content?bno="+move;
		}
	});
	...
	$("#btnDelete").click(function(){
		...
		console.log("bno:", bno);
		location.href = "/company/board/library/library_delete?bno="+bno;
	});
	
	$("#btnModify").click(function(){
		var bno = $(this).attr("data-bno");
		location.href = "/company/board/library/library_modify?bno="+bno;
	});
	
	$("#btnMenu").click(function(){
		location.href = "/company/board/library/library_list";
	});
		...
		<div class="col-md-6">
				<div class="form-group">
					<h1 class="display-5 fw-bolder" id="store"
						style="margin-bottom: 50px; margin-top: 50px;">자료실</h1>
					<div>
						<h3>${boardVo.title }</h3>
					</div>	
				</div>
				...
				<form action="/comment/insertFreeComment" method="post">
				<div>
