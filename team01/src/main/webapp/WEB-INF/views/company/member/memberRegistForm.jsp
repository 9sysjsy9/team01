...
<!-- 가입 정보 입력폼 -->
							...
							<div class="form-group">
								...
								<div class="form-group input-group-sm">
									<label for="userid"> 아이디 </label> <input type="text" class="form-control" id="userid" name="userid" placeholder="Your ID" maxlength="10"/>
								</div>
								
								<div class="form-group input-group-sm">
									<label for="userpw"> 패스워드 </label> <input type="password" class="form-control" id="userpw" name="userpw" placeholder="Your Password" maxlength="10" />
								</div>
								
								<div class="form-group input-group-sm" >
									<label for="chkuserpw"> 패스워드 확인
									 </label> <input type="password" class="form-control" id="chkuserpw" name="chkuserpw" placeholder="Your Password" maxlength="10"/>
								</div>
								
								<div class="form-group input-group-sm">
									<label for="eno"> 사번 </label> <input type="text" class="form-control" id="eno" name="eno" placeholder="Employee Id Num" maxlength="4" />
								</div>
								
								<div class="form-group input-group-sm">
									<label for="username"> 이름 </label> <input type="text" class="form-control" id="username" name="username" placeholder="Name" maxlength="14"/>
								</div>
								...
								<br>
								<button type="button" class="btn btn-outline-primary flex-shrink-0" id="registRunBtn">가입요청</button>
							</form>
						</div>
					</div>
				</div>
