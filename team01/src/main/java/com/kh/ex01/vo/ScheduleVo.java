...
public class ScheduleVo {
	...
	public String toString() {
		return "ScheduleVo [sno=" + sno + ", userid=" + userid + ", syear=" + syear + ", smonth=" + smonth + ", sdate="
				+ sdate + ", content=" + content + ", regdate=" + regdate + ", updatedate=" + updatedate
				+ ", authority=" + authority + "]";
	}
